...
with open('top_tweets.txt', 'r') as infile:
	with open('Output - Q6.txt','w') as outfile:
		for line in infile.readlines():
			text = json.loads(line)
			outfile.write('Tweet Post Date: '+str(text['firstpost_date'])+', Text: '+text['title']+', Number of retweets: '+str(text['tweet']['retweet_count'])+', User: '+text['tweet']['user']['screen_name'])
